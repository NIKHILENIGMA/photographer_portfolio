    ...
    <div className=" bg-(--background) px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
        <div
          ...
          className="relative left-1/2 -z-10 aspect-1155/678 w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-linear-to-tr from-[#f6d2cc] to-[#f6d2cc] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
        />
      </div>
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg/8 text-gray-600">
          Get in touch to discuss your photography needs and create lasting memories together.        </p>
      </div>
      <form
        action="#"
        method="POST"
